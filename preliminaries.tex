...
\begin{figure}
  \centering
  \subfloat[$PK\{(\alpha) : h = g^\alpha \}$\label{msc:schnorr}]{\includegraphics[scale=.45]{mscs/schnorr}}
  \quad
  \subfloat[$PK\{(\alpha) : h \equiv g^\alpha \mod n \}$\label{msc:schnorr_mod}]{\includegraphics[scale=.45]{mscs/schnorr_mod}}
...
\begin{figure}
  \subfloat[$PK\{(\alpha, \beta) : h = g_1^\alpha g_2^\beta \}$\label{msc:okamoto}]{\includegraphics[scale=.45]{mscs/okamoto}}
  \quad
  \subfloat[$PK\{(\alpha, \beta, \gamma) : h = g_1^\alpha g_2^\beta \land \tilde{h} = \tilde{g}_1^\alpha \tilde{g}_2^\gamma\}$\label{msc:equality}]{\includegraphics[scale=.45]{mscs/equality}}
