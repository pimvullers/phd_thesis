...
\section{Schnorr Signature Scheme}\index{signature!Schnorr|see{Schnorr siganture}}
...
of the MULTOS\index{MULTOS} smart card. We had to limit the prime modulus size to 1024 bits,
